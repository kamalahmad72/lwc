...
return
   "<section>
     ...
     <ul>
      <li>Because FF16+ major releases (e.g., FF58) and point releases (e.g., FF58.0.1 - 58.0.2) have identical user-agent string values, it does not accurately detect/report on the latest FF point releases.</li>
