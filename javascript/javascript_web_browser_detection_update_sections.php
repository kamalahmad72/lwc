...
return
   "<section>
     ...
     <ul>
      <li>Because FF16+ major releases (e.g., FF59) and point releases (e.g., FF59.0.1 - 59.0.3) have identical user-agent string values, it does not accurately detect/report on the latest FF point releases.</li>
