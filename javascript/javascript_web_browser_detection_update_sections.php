...
return
   "<section>
     ...
     <ul>
      <li>Because FF16+ major releases (e.g., FF62) and point releases (e.g., FF62.0.2 - 62.0.3) have identical user-agent string values, it does not accurately detect/report on the latest FF point releases.</li>
