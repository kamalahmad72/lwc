...
supportTest = function(){
 ...
 // setTimeout2000ms.
 setTimeout(function(){
  var executionOrderString = &quot;Execution Order 05: Async 03: Executing setTimeout2000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout2000ms callback function placed in job queue 1000ms, not 2000ms, after setTimeout1000ms callback function placed in job queue.&quot;;
  executionOrderReportTest += executionOrderString + &quot; &quot;;
  executionOrderReportElement.innerHTML += &quot;&lt;li&gt;&quot; + executionOrderString + &quot;&lt;/li&gt;&quot;;
 }, 2000);
 // setTimeout3000ms.
 var functionIdentifier = function(){
  var executionOrderString = &quot;Execution Order 06: Async 04: Executing setTimeout3000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout3000ms callback function placed in job queue 1000ms, not 3000ms, after setTimeout2000ms callback function placed in job queue.&quot;;
  executionOrderReportTest += executionOrderString + &quot; &quot;;
  executionOrderReportElement.innerHTML += &quot;&lt;li&gt;&quot; + executionOrderString + &quot;&lt;/li&gt;&quot;;
 ...
 setTimeout(setTimeoutFunctionWithParams, 4000, &quot;Async 05: Executing setTimeout4000ms callback function. &quot;, &quot;Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout4000ms callback function placed in job queue 1000ms, not 4000ms, after setTimeout3000ms callback function placed in job queue.&quot;); // setTimeout() method using named function with parameters syntax. IE9- mistakenly output Execution Order 07: undefined undefined but correctly return timeoutID.
 // setTimeout5000ms.
 setTimeout(&quot;var executionOrderString = 'Execution Order 08: Async 06: Executing setTimeout5000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout5000ms callback function placed in job queue 1000ms, not 5000ms, after setTimeout4000ms callback function placed in job queue.';executionOrderReportTest += executionOrderString + ' ';executionOrderReportElement.innerHTML += '&lt;li&gt;' + executionOrderString + '&lt;/li&gt;';&quot;, 5000); // setTimeout() method using code string syntax. Like eval() method, setTimeout() method interprets string argument as JavaScript code, which is a security risk. AVOID.
 // setTimeout6000ms.
 ...
 // setTimeout7000ms.
 setTimeout(function(){
  var executionOrderString = &quot;Execution Order 10: Async 08: Executing setTimeout7000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method cancelled. (NOTE: Execution Order 09: Async 07: setTimeout6000ms cancelled by &lt;code&gt;clearTimeout()&lt;/code&gt; method.) Therefore, setTimeout7000ms callback function placed in job queue 2000ms, not 7000ms, after setTimeout5000ms callback function placed in job queue.&quot;;
  executionOrderReportTest += executionOrderString + &quot; &quot;;
  executionOrderReportElement.innerHTML += &quot;&lt;li&gt;&quot; + executionOrderString + &quot;&lt;/li&gt;&quot;;
  if (window.setTimeout){ // Implementation test.
   if ((anonymousFunctionThisValue === window) &amp;&amp; (functionIdentifierThisValue === window) &amp;&amp; (executionOrderReportTest === &quot;Execution Order 01: Sync 01: Executing code at top of &lt;code&gt;capabilityTest()&lt;/code&gt; function. Execution Order 02: Sync 02: Executing code at bottom of &lt;code&gt;capabilityTest()&lt;/code&gt; function. The &lt;code&gt;setTimeout()&lt;/code&gt; method code is located between the Sync 01 and Sync 02 code. The &lt;code&gt;setTimeout()&lt;/code&gt; method code is parsed as normal synchronously. The &lt;code&gt;setTimeout()&lt;/code&gt; method callback functions are executed asynchronously as demonstrated below. (NOTE: Execution Order 09: Async 07: setTimeout6000ms cancelled by &lt;code&gt;clearTimeout()&lt;/code&gt; method.) Execution Order 03: Async 01: Executing setTimeout0ms callback function. Executed before setTimeout1000ms callback function even though setTimeout0ms appears in code after setTimeout1000ms. Execution Order 04: Async 02: Executing setTimeout1000ms callback function. Executed after setTimeout0ms callback function even though setTimeout1000ms appears in code before setTimeout0ms. Execution Order 05: Async 03: Executing setTimeout2000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout2000ms callback function placed in job queue 1000ms, not 2000ms, after setTimeout1000ms callback function placed in job queue. Execution Order 06: Async 04: Executing setTimeout3000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout3000ms callback function placed in job queue 1000ms, not 3000ms, after setTimeout2000ms callback function placed in job queue. Execution Order 07: Async 05: Executing setTimeout4000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout4000ms callback function placed in job queue 1000ms, not 4000ms, after setTimeout3000ms callback function placed in job queue. Execution Order 08: Async 06: Executing setTimeout5000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method callback function executed. Therefore, setTimeout5000ms callback function placed in job queue 1000ms, not 5000ms, after setTimeout4000ms callback function placed in job queue. Execution Order 10: Async 08: Executing setTimeout7000ms callback function. Time counted from when &lt;code&gt;setTimeout()&lt;/code&gt; method parsed, not from when previous &lt;code&gt;setTimeout()&lt;/code&gt; method cancelled. (NOTE: Execution Order 09: Async 07: setTimeout6000ms cancelled by &lt;code&gt;clearTimeout()&lt;/code&gt; method.) Therefore, setTimeout7000ms callback function placed in job queue 2000ms, not 7000ms, after setTimeout5000ms callback function placed in job queue. &quot;)){ // Capability test.
