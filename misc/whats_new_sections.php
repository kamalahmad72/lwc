...
<!-- Resources are \"Added\". Instructional pages are \"Published\". Always keep when a page is \"Added/Published\". When a page is \"Major update\" remove prior \"Updated/Major update\". When a page is \"Updated\" remove prior \"Updated\". When a page is \"Updated\" keep prior \"Major update\". When a page is \"Updated/Major update\" remove prior \"Renamed\". When a page is \"Renamed\" without being \"Updated\" keep prior \"Updated/Major update\". When a page is \"Renamed\" and \"Updated\" remove prior \"Updated\" and keep prior \"Major update\". When a page is \"Renamed\" rename all refs to the page (including Updated/Major update/Added/Published) to the new name. When a page is \"Deleted\" remove prior \"Published\", remove prior \"Updated\, and mention page \"Deleted.\". When a page is \"Moved to discontinued\" keep prior \"Published\", remove prior \"Updated\", and do not mention page \"Moved to discontinued\". -->
     <ul class='link-list'>
      <li>Visualize Bootstrap v3.3.x Media Query Viewport Breakpoints renamed <a href='/css/css_testing_ground/visualize_bootstrap_media_query_viewport_breakpoints.html'>Visualize Bootstrap Media Query Viewport Breakpoints (learnwebcoding.com)</a>: Major update: 05 Dec 2018.</li>
      <li><a href='/css/css_testing_ground/index.php'>CSS Testing Ground (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li>
      <li><a href='/css/index.php'>CSS (learnwebcoding.com)</a> Landing Page: Updated: 05 Dec 2018.</li>
      <li><a href='/misc/original_content.php'>Original Content (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li>
      <li><a href='/sitemap.xml'>Learn Web Coding Site Map (XML Version Per Sitemaps.org) (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li><!-- Submit to Google Search Console (formerly Google Webmaster Tools). -->
      <li><a href='/sitemap.php'>Learn Web Coding Site Map (HTML Version) (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li>
      <li><a href='/javascript/web_browser_useragent_values.php'>Web Browser User-Agent String Values (learnwebcoding.com)</a> and <a href='/javascript/javascript_web_browser_detection_update.php'>JavaScript Web Browser Detection With Link To Download Update (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li>
      <li><a href='/css/css_testing_ground/visualize_user_agent_or_bootstrap_styles.html'>Visualize User Agent Or Bootstrap Styles (learnwebcoding.com)</a>: Updated: 05 Dec 2018.</li>
