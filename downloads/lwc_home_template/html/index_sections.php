   ...
   "<section>
    ...
    <section>
     ...
     <ul class='link-list'>
      ...
      <li><a href=''><s>Valid HTML 4.01 Transitional Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Valid HTML 4.01 Strict Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Valid XHTML 1.0 Transitional Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Valid XHTML 1.0 Strict Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Valid XHTML 1.1 Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Valid HTML5 Template (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>Blank Web Page (learnwebcoding.com)</s></a></li>
      <li><a href=''><s>HTML Testing Ground (learnwebcoding.com)</s></a>
       <ul class='link-list'>
        <li><a href=''><s>Does The Web Browser Retain Or Remove Manually And Programmatically Entered/Displayed Web Page Content Upon F5 (Refresh/Reload)? (learnwebcoding.com)</a></s></li>
       </ul>
      </li>
     </ul>
    ...
    <section>
     ...
     <h3><a id='w3cHtml32'></a>3.1. W3C HTML 3.2, 4.0, And 4.01 Recommendations</h3>
     ...
     <h3><a id='w3cXhtml'></a>3.2. W3C XHTML Recommendations/Etc.</h3>
...
<!-- List from top to bottom; 1.) Recommendations, 2.) Proposed Recommendations, 3.) Candidate Recommendations, 4.) Working Group Notes, 5.) all Working Drafts incl Last Call and First Public, and Editor's Drafts, and 6.) within each list by date newest on top to date oldest on bottom. -->
     ...
     <h3><a id='whatwgHtml'></a>3.4. WHATWG HTML Specification</h3>
