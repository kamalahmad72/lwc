...
/* File: /web_server_root_directory/templates/overall_home_page.php.
 * Purpose: Web page overall HTML/PHP template file. A variation of /web_server_root_directory/templates/overall.php.
  ...
  <footer>
   <div class='container-fluid'><!-- container-fluid from Bootstrap. -->
    <div class='home-page-footer'>
     ...
     Last reviewed/updated: 10 Mar 2018<br />
