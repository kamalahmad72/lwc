 ...
 * Purpose: Web page <header></header> section code file. Replace the <header></header> section code example below with your <header></header> section code, coded per LWC Home Template Explained (https://www.learnwebcoding.com/html/template_explained.php).
